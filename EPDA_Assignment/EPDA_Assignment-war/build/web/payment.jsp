<%-- 
    Document   : payment
    Created on : Sep 15, 2024, 4:44:22 PM
    Author     : Dell Vostro
--%>
...
<body>
    ...
    <div class="card border-light mt-2" style="width: 100%;">
        <div class="card-body pt-1">
            ...
            <form action="Payment" method="POST" id="createForm">
                <div class="row mb-4">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="text-center">
                                            <c:choose>
                                                <c:when test="${sales.status eq 'Pending'}">
                                                    <a href="javascript:void(0)" class="btn btn-light btn-sm pay-btn" data-id="${sales.id}">Pay</a>
                                                </c:when>
                                                <c:otherwise>
                                                    <a href="javascript:void(0)" class="btn btn-light btn-sm pay-btn" data-id="${sales.id}">View</a>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </td>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '.pay-btn', function() {
                ...
                window.location.href = "${pageContext.request.contextPath}/PaymentDetails?salesId=" + dataId;
            });
        });
    </script>
</body>
