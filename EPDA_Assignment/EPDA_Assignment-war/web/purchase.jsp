<%-- 
    Document   : purchase
    Created on : Sep 16, 2024, 2:11:47 PM
    Author     : Dell Vostro
--%>
...
<body>
    ...
    <div class="card border-light mt-2" style="width: 100%;">
        <div class="card-body pt-1">
            ...
            <form action="Purchase" method="POST" id="createForm">
                <div class="row mb-4">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="text-center">
                                            <c:choose>
                                                <c:when test="${sales.status eq 'Completed'}">
                                                    <a href="javascript:void(0)" class="btn btn-light btn-sm feedback-btn" data-id="${sales.id}">Feedback</a>
                                                </c:when>
                                                <c:otherwise>
                                                    <a href="javascript:void(0)" class="btn btn-light btn-sm feedback-btn" data-id="${sales.id}">View</a>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </td>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '.feedback-btn', function() {
                ...
                window.location.href = "${pageContext.request.contextPath}/PurchaseDetails?salesId=" + dataId;
            });
        });
    </script>
</body>
