<%-- 
    ...
    Created on : Sep 16, 2024, 12:32:04 AM
    Author     : Dell Vostro
--%>
    ...
    <div class="card border-light mt-2" style="width: 100%;">
        <div class="card-body pt-1">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <form action="SalesDetails" method="POST" id="createForm">
                        ...
                        <c:if test="${feedbackHasData}">
                            ...
                            <c:if test="${not empty feedback}">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <textarea class="form-control" id="feedback" name="feedback" row="3" readonly disabled>${feedback}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </c:if>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <textarea class="form-control" id="comment" name="comment" row="3" required>${not empty comment ? comment : ''}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col text-end">
                                <a href="<c:url value='/Sales' />" class="btn btn-light">Cancel</a>
